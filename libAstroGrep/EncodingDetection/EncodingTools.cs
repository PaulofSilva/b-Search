...
namespace libbSearch.EncodingDetection
{
   ...
   public static class EncodingTools
   {
      ...
      /// <history>
      /// [Paulo_Silva]		05/18/2015	FIX: 69, set max size to 1024 instead of 10240
      /// </history>
      ...
      /// <returns>byte array of sample data</returns>
      /// <history>
      /// [Paulo_Silva]		05/18/2015	FIX: 69, initial to use open stream.  set max size to 1024 instead of 10240
      /// </history>
