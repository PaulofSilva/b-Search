...
namespace bSearch.Windows.Controls
{
    ...
    /// <summary>
    /// A custom implemenation of the TextEditor control for use with bSearch providing a custom line numbering margin.
    /// </summary>
    /// <remarks>
    ...
    public class TextEditorEx : TextEditor
    {
        ...
        /// </summary>
        /// <history>
        /// [Paulo_Silva]	  05/28/2015	FIX: 74, invalidate measure when numbers are updated
        /// </history>
        ...
        /// </summary>
        /// <history>
        /// [Paulo_Silva]	   05/11/2015	CHG: zoom for TextEditor control
        /// </history>
        public void ZoomIn()
        {
