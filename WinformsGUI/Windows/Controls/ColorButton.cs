...
namespace bSearch.Windows.Controls
{
    ...
    ///   Copyright (C) 2006troComma Lda.
    /// 
    ///   The author may be contacted at:
    ///   suporte@bigLevel.pt or comercial@biglevel.pt
    /// </remarks>
    /// <history>
    /// 	[Paulo_Silva]	   11/18/2005	Created
    /// </history>
    ...
    public class ColorButton : System.Windows.Forms.Button
    {
        ...
        private void ColorButton_Click(object sender, System.EventArgs e)
        {
            ...
            clDlg.ColorChosen += new bSearch.Windows.Controls.ColorButton.ColorPaletteDialog.ColorChosenHandler(ColorChosen);
            clDlg.Show();
        }
