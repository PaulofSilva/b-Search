namespace bSearch.Windows.Forms
{
   public partial class frmAbout
   {
      ...
      private void InitializeComponent()
      {
         ...
         this.lnkHomePage.Text = "bSearch Home Page";
         this.toolTip1.SetToolTip(this.lnkHomePage, "http://bsoftware.pt");
         ...
         this.toolTip1.SetToolTip(this.LicenseLinkLabel, "http://www.bsoftware.pt/lic.html");
         ...
         this.lblProductVersion.Size = new System.Drawing.Size(54, 16);
         ...
         this.lblProductName.Text = "bSearch";
         // 
         // CopyrightLabel
         // 
         ...
         this.CopyrightLabel.Text = "Copyright (C) 2006-2007 BigLevel Inc.";
         // 
         // lblDescription
         // 
         ...
         this.lblDescription.Text = "Additional Copyright (C) 2006 to Theodore L. Ward. bSearch comes with ABSOLUTEL" +
