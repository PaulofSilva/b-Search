...
namespace bSearch.Common.Logging
{
   /// <summary>
   /// 
   /// </summary>
   /// <remarks>
   ///   bSearch File Searching Utility. Written by Theodore L. Ward
   ...
   /// </remarks>
   /// <history>
   /// [Paulo_Silva]	   04/08/2015	Add: logging
   /// </history>
   public class LogClient : ILogClient
   {
      ...
      /// </summary>
      /// <history>
      /// [Paulo_Silva]	   04/08/2015	CHG: add logging
      /// </history>
      private LogClient()
      {
         ...
         this.logFile = ApplicationPaths.LogFile;
